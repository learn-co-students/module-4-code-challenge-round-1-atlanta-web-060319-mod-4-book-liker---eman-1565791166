...
const BotSpecs = props => {
  let { bot, addBot, returnToHome, selectedBot } = props;
      ...
      <div className="ui two column centered grid">
        <div className="row">
          ...
          <div className="four wide column">
            ...
            <button className="ui button fluid" onClick={() => returnToHome(selectedBot)}>
              Go Back
            </button>
            <button className="ui button fluid" onClick={() => addBot(bot)}>
              Enlist
            </button>
          </div>
        </div>
